        ...
        <div>
            <div className='w-full h-70 bg-gray-800 '>
                <div className='text-white text-center p-17'>
                    ...
                    <button className="bg-white h-9 w-40 rounded-md text-black font-medium hover:bg-gray-200 hover:cursor-pointer transition-transform duration-200 transform hover:scale-110">Get Started Free</button>
                </div>
            </div>
                    ...
                    <div className='w-1/4'>
                        ...
                        <div className="flex">
                            ...
                            <div className="w-8 h-8 rounded-full bg-gray-800  flex justify-center items-center hover:cursor-pointer transition-transform transform hover:scale-110">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-linkedin-icon lucide-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect width="4" height="12" x="2" y="9" /><circle cx="4" cy="4" r="2" /></svg>
                            </div>
                        </div>
                    </div>
                </div>
