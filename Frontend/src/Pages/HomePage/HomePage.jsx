        ...
        <div>
            ...
            <div className='bg-gray-100 w-full h-130 flex justify-center items-center'>
                <div className='pr-30'>
                    ...
                    <div className="flex gap-4 pt-15">
                        <button onClick={()=>navigate("/signin")} className="flex items-center gap-2 bg-gray-900 text-white px-5 py-2 rounded-md font-medium hover:bg-gray-800 transition hover:cursor-pointer transform hover:scale-105">
            ...
            <div>
                ...
                <div id='outerdiv' className='pt-20 pb-25 flex justify-center'>
                    ...
                    <div className='w-1/3 text-center'>
                        <div className='rounded-full bg-gray-200 w-12 h-12 flex items-center justify-center mx-auto'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chart-pie-icon lucide-chart-pie"><path d="M21 12c.552 0 1.005-.449.95-.998a10 10 0 0 0-8.953-8.951c-.55-.055-.998.398-.998.95v8a1 1 0 0 0 1 1z"/><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/></svg>
                        </div>
                        <div className=''>
                    ...
                    <div className='w-1/3 text-center'>
                        <div className='rounded-full bg-gray-200 w-12 h-12 flex items-center justify-center mx-auto'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chart-line-icon lucide-chart-line"><path d="M3 3v16a2 2 0 0 0 2 2h16"/><path d="m19 9-5 5-4-4-3 3"/></svg>
                        </div>
                        <div className=''>
